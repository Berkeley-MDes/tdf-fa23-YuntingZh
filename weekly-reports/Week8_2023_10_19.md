...
### Task
- [] figure out webhooks and how to add them via the Particle console
'''javascript
...
10/14/2023
Task
-[]figure out how to use webhook - Create a Particle.io Integration
...
'''
## 10/17 
Considering the delay when triggering events via cloud data, we shifted to a better solution which is using TouchDesigner. 
